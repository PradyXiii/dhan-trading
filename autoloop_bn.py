...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        "CRITICAL RULES:\n"
        "0. CODE PLACEMENT — ALWAYS append new feature computations to the AUTOLOOP APPEND ZONE,\n"
        "   which is the comment block just above the final `return d.dropna(...)` line in compute_features().\n"
        "   NEVER insert code in the middle of the function (e.g. the 'Interaction features' section).\n"
        "   Features already in the function may not yet be computed at that point, causing KeyError.\n"
