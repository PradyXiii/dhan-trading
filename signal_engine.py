...
_RBI_MPC_DECISION_DAYS = {
    ...
    # 2026  (verify at rbi.org.in each year — published ~6 months in advance)
    "2026-02-06", "2026-04-09", "2026-06-05",
    "2026-08-07", "2026-10-09", "2026-12-05",
    # 2027  ← UPDATE THESE before Jan 2027 from rbi.org.in → Monetary Policy
    "2027-02-05", "2027-04-09", "2027-06-04",
    "2027-08-06", "2027-10-08", "2027-12-03",
}
